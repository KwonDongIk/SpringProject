...
<div class="login_form">
	...
	<fieldset id="login_fieldset">
		...
		<img src="<c:url value='/images/egovframework/com/uat/uia/EgoWaeyoLogo01.png'/>" style="margin:30px 60px 30px 60px; display: block; margin-left: auto;
  					margin-right: auto; width:300px;" alt="login title image"  title="login title image">
